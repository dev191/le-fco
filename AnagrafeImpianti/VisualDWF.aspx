<%@ Page language="c#" Codebehind="VisualDWF.aspx.cs" AutoEventWireup="false" Inherits="TheSite.AnagrafeImpianti.VisualDWF" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 102; POSITION: absolute; WIDTH: 100%; HEIGHT: 100%; TOP: 0px; LEFT: 0px"
				...
				<TR>
					<TD>
						<cc1:datapanel id="DataPanel1" runat="server" AllowTitleExpandCollapse="True" CollapseImageUrl="../Images/up.gif"
							CssClass="DataPanel75" CollapseText="Riduci" ExpandImageUrl="../Images/down.gif" ExpandText="Espandi"
							TitleText="Dati Generali " Collapsed="False" TitleStyle-CssClass="TitleSearch">
							<asp:Repeater id="Repeater1" runat="server">
								...
								<FooterTemplate>
									<br>
									<%if(Context.Handler is TheSite.AnagrafeImpianti.NavigazioneDocumenti || Context.Handler is TheSite.AnagrafeImpianti.NavigazioneCertificati){%>
									<table>
										<tr>
											<td><input type="button" id="btnh" value="Indietro" onclick="javascript:history.back();"></td>
										</tr>
									</table>
									<%}else{%>
									<table>
										<tr>
											<td><input type="button" id="btnclose" value="Chiudi" onclick="javascript:window.close();"></td>
										</tr>
									</table>
									<%}%>
								</FooterTemplate>
