...
<HTML>
	...
	INPUT { BORDER-RIGHT: #464a50 1px solid; PADDING-RIGHT: 2px; BORDER-TOP: #464a50 1px solid; PADDING-LEFT: 2px; FONT-WEIGHT: normal; FONT-SIZE: 11px; PADDING-BOTTOM: 2px; BORDER-LEFT: #464a50 1px solid; COLOR: #990033; PADDING-TOP: 2px; BORDER-BOTTOM: #990033 1px solid; FONT-FAMILY: Tahoma }
		</STYLE>
					...
					<TD valign="middle">
						<DIV align="center">
							<TABLE style="BORDER-RIGHT: slategray 1px outset; BORDER-TOP: slategray 1px outset; BORDER-LEFT: slategray 1px outset; WIDTH: 430px; BORDER-BOTTOM: slategray 1px outset; HEIGHT: 300px"
								...
								<TR>
									<TD colspan="2" style="COLOR: white">Inserisci la username e la password relativa 
										al sistema informativo per la gestione dei servizi di: <b>
											<%= TheSite.Classi.Helper.GetApplicationName()%>
										</b>
									</TD>
								</TR>
