...
<%@ Page language="c#" Codebehind="ListDestinatari_Email.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.ListDestinatari_Email" %>
									...
									<cc1:DataPanel id="DataPanel1" runat="server" TitleStyle-CssClass="TitleSearch" Collapsed="False"
										...
										<TABLE border="0" width="100%">
											<TR>
												...
												<TD>
													<cc2:S_Button id="btReset" runat="server" CssClass="btn" Width="88px" Text="Indietro"></cc2:S_Button></TD>
