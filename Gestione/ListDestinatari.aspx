<%@ Page language="c#" Codebehind="ListDestinatari.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.ListDestinatari" %>
							...
							<TR>
								<TD>
									<cc1:DataPanel id="DataPanel1" runat="server" TitleStyle-CssClass="TitleSearch" Collapsed="False"
										TitleText="Criteri di Ricerca" ExpandText="Espandi" ExpandImageUrl="../Images/down.gif" CollapseText="Riduci"
										...
										<TABLE id="tblSearch100" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												...
												<TD style="WIDTH: 264px">
													<asp:TextBox id="txtEmail" runat="server" Width="268px"></asp:TextBox></TD>
												<TD>Abilitati a ricevere Email:</TD>
												<TD>
													<asp:DropDownList id="CmbsAbilitati" runat="server">
														<asp:ListItem Value="1">Abilitati Si</asp:ListItem>
														<asp:ListItem Value="0">Abilitati No</asp:ListItem>
													</asp:DropDownList></TD>
											</TR>
										</TABLE>
									...
									<asp:DataGrid id="DataGrid1" runat="server" CssClass="DataGrid" Width="100%" BorderColor="Gray"
										...
										<Columns>
											<asp:TemplateColumn>
												...
												<ItemTemplate>
													<a href='EditDestinatario.aspx?ItemID=<%# DataBinder.Eval(Container.DataItem,"id") + "&FunId=" + _SiteModule.ModuleId%>'>
											...
											<asp:TemplateColumn>
												...
												<ItemStyle HorizontalAlign="Center"></ItemStyle>
												<ItemTemplate>
													<asp:ImageButton ImageUrl="../Images/elimina.gif" Runat="server" CommandName="Delete" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"id")%>' ID="bt2">
													</asp:ImageButton>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:BoundColumn DataField="edif" HeaderText="Cod.Edificio"></asp:BoundColumn>
											<asp:BoundColumn DataField="email" HeaderText="Email"></asp:BoundColumn>
											<asp:BoundColumn DataField="Servizio" HeaderText="Servizio"></asp:BoundColumn>
											<asp:BoundColumn DataField="tipo_doc" HeaderText="Tipo Documento"></asp:BoundColumn>
											<asp:BoundColumn DataField="Abilitato" HeaderText="Abilitato"></asp:BoundColumn>
										</Columns>
