...
<%@ Page language="c#" Codebehind="EmailEdificiServizi.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.EmailEdificiServizi" %>
						...
						<TABLE id="tblFormInput" cellSpacing="1" cellPadding="1" align="center">
							...
							<TR>
								...
								<TD style="HEIGHT: 190px" vAlign="top" align="left"><asp:panel id="PanelEdit" runat="server" Height="493px">
										<TABLE id="tblSearch100" style="WIDTH: 100%; HEIGHT: 446px" cellSpacing="1" cellPadding="2"
											border="1">
											<TR>
											...
											<TR>
												...
												<TD style="WIDTH: 222px; HEIGHT: 2px"></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD style="WIDTH: 296px; HEIGHT: 14px" colSpan="2">
													<cc1:s_button id="btnsSalva" tabIndex="11" runat="server" CssClass="btn" Width="272px" Text="Salva Associazione Email Edifici Servizi"></cc1:s_button></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 296px; HEIGHT: 14px" colSpan="2">
													<cc1:s_button id="btnsSalvaglb" tabIndex="11" runat="server" CssClass="btn" Width="272px" Text="Salva Associazione Email Edifici Servizi globale"></cc1:s_button></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 296px; HEIGHT: 14px" colSpan="2">
													<cc1:s_button id="btnsEliminaglb" tabIndex="11" runat="server" CssClass="btn" Width="272px" Text="Elimina Associazione Email Edifici Servizi globale"></cc1:s_button></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 296px" colSpan="2">
													<asp:button id="btnAnnulla" tabIndex="13" runat="server" CssClass="btn" Width="272px" Text="Indietro"
