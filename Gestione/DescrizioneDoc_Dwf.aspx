							...
							<TR>
								<TD style="WIDTH: 128px" colSpan="2">
									<TABLE id="TableVVf" cellSpacing="1" cellPadding="1" width="400" border="0" runat="server">
										<TR>
											<TD style="WIDTH: 145px">N° Fascicolo VVF:
											</TD>
										...
										<TR>
											<TD style="WIDTH: 145px">N° Protocollo:
											</TD>
											<TD><cc1:s_textbox id="txtProtocollo" runat="server" DBDirection="Input" DBParameterName="p_protocollo"
													DBIndex="2" Width="224px" MaxLength="20" DBSize="20"></cc1:s_textbox></TD>
										</TR>
										<TR>
											<TD style="WIDTH: 145px">Data Rilascio:</TD>
											<TD><uc1:calendarpicker id="CalendarPicker1VVF" runat="server"></uc1:calendarpicker></TD>
										</TR>
										<TR>
											<TD style="WIDTH: 145px">Data Scadenza:</TD>
									...
									<TABLE id="TableISPESL" cellSpacing="1" cellPadding="1" width="400" border="0" runat="server">
										<TR>
											<TD>Matricola nr:<asp:requiredfieldvalidator id="RequiredFieldValidator4" runat="server" Display="None" ControlToValidate="txtISPESL"
