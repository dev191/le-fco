...
namespace TheSite.Gestione
{
	...
	public class DescrizioneDoc_Dwf : System.Web.UI.Page
	{
		...
		protected S_Controls.S_TextBox txtProtocollo;
...
//				}
				...
				if(Dr["protocollo_vvf"]!=DBNull.Value) 
					txtProtocollo.Text  =Dr["protocollo_vvf"].ToString();
...
//		}
		...
		private void execute()
		{
			...
			//Collaudo
			S_Controls.Collections.S_Object s_p_protocollo = new S_Object();
			s_p_protocollo.ParameterName = "p_protocollo";
			s_p_protocollo.DbType = CustomDBType.VarChar;
			s_p_protocollo.Direction = ParameterDirection.Input;
			s_p_protocollo.Size=100;
			s_p_protocollo.Index =6;
			s_p_protocollo.Value = txtProtocollo.Text;
			_SColl.Add(s_p_protocollo);
