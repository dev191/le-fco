...
{
	/// <summary>
	/// Descrizione di riepilogo per EmailEdifici.
	/// </summary>
	public class EmailEdifici : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{	
				...
				this.lblOperazione.Text = "Associazione Email Edifici";
		...
		{			
			...
			CaricaListaLeft();
			CaricaListaRight();	
			lblMessage.Text="Inserita-Modificata Associazione Email Edifici";
		}

		private void btnAnnulla_Click(object sender, System.EventArgs e)
		{
			//Response.Redirect((String) ViewState["UrlReferrer"]);
			Response.Redirect("Email.aspx?FunId="+FunId);
		}

		private void btnAssociaServizi_Click(object sender, System.EventArgs e)
		{
			string _urlpage = "EmailEdificiServizi.aspx?itemId="+itemId+"&descr="+LblEmail.Text;
