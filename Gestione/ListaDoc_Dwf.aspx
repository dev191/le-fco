			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TR>
						...
						<TABLE id="tblSearch100" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD><cc1:datapanel id="DataPanel1" runat="server" AllowTitleExpandCollapse="True" CollapseImageUrl="../Images/up.gif"
										...
										TitleText="Anagrafe Documenti" Collapsed="False" TitleStyle-CssClass="TitleSearch">
										<TABLE id="tblSearch100" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD>
                  ...
                  target=_blank>Guida</A></TD>
							...
							<TR>
								<TD><uc1:gridtitleserver id="GridTitleServer1" runat="server"></uc1:gridtitleserver><asp:datagrid id="DataGrid1" runat="server" CssClass="DataGrid" Width="100%" GridLines="Vertical"
						...
						<cc2:s_label id="lblError" runat="server" ForeColor="Red"></cc2:s_label></TD>
				</TR>
			</TABLE>
		</form>
