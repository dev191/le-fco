...
namespace TheSite.Gestione
{
	...
	/// </summary>
	public class ListDestinatari_Email : System.Web.UI.Page
	{
...
//			this.DataGrid1.Columns[1].Visible = _SiteModule.IsEditable;
		...
		private void Ricerca( int ItemId)
		{
			...
			DataSet ds = _MailSend.GetDataEmail(_SCollection);
