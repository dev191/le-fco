...
namespace TheSite.Classi.AnagrafeImpianti
{
	...
	public class AnagrafeDocDWF: AbstractBase
	{
		...
		public override DataSet GetSingleData(int itemId)
		{
			...
			s_p_id_doc.Index = CollezioneControlli.Count ;
			s_p_id_doc.Value =0;
			...
			s_p_username.Index = CollezioneControlli.Count ;
			...
			string s_StrSql = "PACK_DOCUMENTI.GETDatidocdwf";	
		...
		public  DataSet GetSingleData_rv(int IdBl,int idDoc)
		{
			S_ControlsCollection CollezioneControlli=new S_ControlsCollection();
