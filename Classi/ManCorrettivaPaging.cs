...
namespace TheSite.Classi.ManStraordinaria
{
	...
	public class ManCorrettivaPaging : AbstractBase
	{
			...
			using(OracleConnection connection = new OracleConnection(ConnectionString))
			{
				try
				{
					...
					using(OracleCommand command = new OracleCommand(s_StrSql,connection))
					{
						...
						OracleParameter p4 = new OracleParameter("MSG_OUT",OracleType.VarChar,1000);
						p4.Value     = "";
		...
		public string  CKStatusAut(int P_wr_id, int P_tipomanutenzione_id)
		{
			string Result="";
			string ConnectionString=ConfigurationSettings.AppSettings.Get("ConnectionString");
			string s_StrSql = "PACK_MANCORRETIVA.SP_CK_WR_STAUTORIZ";
			using(OracleConnection connection = new OracleConnection(ConnectionString))
			{
				try
				{
					...
					using(OracleCommand command = new OracleCommand(s_StrSql,connection))
					{
						...
						OracleParameter p2 = new OracleParameter("P_tipomanutenzione_id",OracleType.Number);
						p2.Value     = P_tipomanutenzione_id;
						p2.Direction = System.Data.ParameterDirection.Input;
						command.Parameters.Add(p2);

						OracleParameter p3 = new OracleParameter("MSG_OUT",OracleType.VarChar,100);
						p3.Value     = "";
		...
		public string  CKSogliaAut(double P_importo, int P_id_servizio,int P_wr_id)
		{
//			 PROCEDURE SP_CK_SOGLIA_SERV(P_id_servizio in number,
//                              P_importo              in number,
//                              P_wr_id                in number,
//                              MSG_OUT                in out boolean)
			
			string Result="";
			string ConnectionString=ConfigurationSettings.AppSettings.Get("ConnectionString");
			string s_StrSql = "PACK_MANCORRETIVA.SP_CK_SOGLIA_SERV";
			using(OracleConnection connection = new OracleConnection(ConnectionString))
			{
				try
				{
					...
					using(OracleCommand command = new OracleCommand(s_StrSql,connection))
					{
						...
						OracleParameter p1 = new OracleParameter("P_importo",OracleType.Number);
						p1.Value     = P_importo;
						p1.Direction = System.Data.ParameterDirection.Input;
						command.Parameters.Add(p1);

						OracleParameter p2 = new OracleParameter("P_id_servizio",OracleType.Number);
						p2.Value     = P_id_servizio;
						p2.Direction = System.Data.ParameterDirection.Input;
						command.Parameters.Add(p2);
		...
		public string  CKPREVAUT(string utente)
		{
			//			 PROCEDURE SP_CK_SOGLIA_SERV(P_id_servizio in number,
			//                              P_importo              in number,
			//                              P_wr_id                in number,
			...
			string Result="";
			string ConnectionString=ConfigurationSettings.AppSettings.Get("ConnectionString");
			string s_StrSql = "PACK_UTENTI.SP_RUOLO_AUT_PREV";
			using(OracleConnection connection = new OracleConnection(ConnectionString))
			{
				try
				{
					...
					using(OracleCommand command = new OracleCommand(s_StrSql,connection))
					{
						...
						OracleParameter p1 = new OracleParameter("p_UserName",OracleType.VarChar,100);
						p1.Value     = utente.ToString();
						p1.Direction = System.Data.ParameterDirection.Input;
						command.Parameters.Add(p1);
						
						

						OracleParameter p2 = new OracleParameter("p_msg_out",OracleType.VarChar,100);
						p2.Value     = "";
...
//		public string Ruolo_Pagina_modifica(string p_utente, string p_pagina)
//		{
//			string Result="OK";
//
//			
//			string ConnectionString=ConfigurationSettings.AppSettings.Get("ConnectionString");
//			string s_StrSql = "PACK_RUOLI.SP_CK_MODIFICA_RUOLO_PAG";
//			using(OracleConnection connection = new OracleConnection(ConnectionString))
//			{
//				try
//				{
...
//						command.CommandType = System.Data.CommandType.StoredProcedure;
//					
//						OracleParameter p1 = new OracleParameter("p_utente",OracleType.VarChar);
//						p1.Value     = p_utente;
//						p1.Direction = System.Data.ParameterDirection.Input;
//						command.Parameters.Add(p1);
//						
//						OracleParameter p2 = new OracleParameter("p_pagina",OracleType.VarChar);
//						p2.Value     = p_pagina;
//						p2.Direction = System.Data.ParameterDirection.Input;
//						command.Parameters.Add(p2);
//
