...
namespace TheSite.Classi.ManOrdinaria
{
	...
	public class Richiesta : AbstractBase
	{
		...
		public override DataSet GetSingleData(int itemId)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_GETSINGLERICHIESTA";	
		...
		public int Crea_DEMO(S_ControlsCollection CollezioneControlli)
		{
			int i_Result = 0;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MAN_ORD.SP_CREA_DEMO";	
		...
		public int Crea_Rev(S_ControlsCollection CollezioneControlli)
		{
			int i_Result = 0;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_CREA_REV";	
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, s_StrSql);			

			return i_Result;		
		}
		public int Crea_Rev1(S_ControlsCollection CollezioneControlli)
		{
			int i_Result = 0;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_CREA_REV1_";	
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, s_StrSql);			
		...
		public DataSet GetAddettiDitta(int p_ditta_id)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_ADDETTI.SP_GETADDETTODITTA_";	
			_Ds = _OraDl.GetRows(_SCollection, s_StrSql).Copy();			
		...
		public  DataSet GetHWR(S_ControlsCollection CollezioneControlli,string utente)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MAN_ORD.SP_GETHWR1";
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public int ModificaRDL_DEMO(S_ControlsCollection CollezioneControlli,int wr_id)
		{
			int i_Result = 0;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MAN_ORD.SP_UPDRDL_DEMO";	
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, s_StrSql);			
		...
		public int ModificaRDL_Rev(S_ControlsCollection CollezioneControlli,int wr_id)
		{
			int i_Result = 0;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_UPDRDL_REV";	
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, s_StrSql);			

			return i_Result;		
		}

		public int ModificaRDL_Rev1(S_ControlsCollection CollezioneControlli,int wr_id)
		{
			int i_Result = 0;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_UPDRDL_REV1_";	
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, s_StrSql);			
		...
		public string GETrepeatclick(int wr_id, string SGA)
		{	
			...
			S_Controls.Collections.S_Object s_p_user = new S_Object();
			s_p_user.ParameterName = "p_user";
			s_p_user.DbType = CustomDBType.VarChar;
			s_p_user.Direction = ParameterDirection.Input;
			s_p_user.Index = CollezioneControlli.Count;
			s_p_user.Value = User;			
			CollezioneControlli.Add(s_p_user);

			S_Controls.Collections.S_Object s_p_sga_die = new S_Object();
			s_p_sga_die.ParameterName = "p_sga_die";
			s_p_sga_die.DbType = CustomDBType.VarChar;
			s_p_sga_die.Direction = ParameterDirection.Input;
			s_p_sga_die.Index = CollezioneControlli.Count;
			s_p_sga_die.Value = SGA;			
			CollezioneControlli.Add(s_p_sga_die);	
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_TRACCIA_DOC.SP_GETrepeatclick_V";	
			DataSet _Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
			DataRow _DrData = _Ds.Tables[0].Rows[0];			
			string Result=_DrData["str"].ToString();
			return Result;
