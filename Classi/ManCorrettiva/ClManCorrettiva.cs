...
namespace TheSite.Classi.ManCorrettiva
{
	...
	public class ClManCorrettiva:AbstractBase
	{
		...
		public DataSet GetSingleRdl_PREV(int itemId)
		{
			DataSet _Ds;
			...
			S_Controls.Collections.S_Object s_user = new S_Object();
			s_user.ParameterName = "p_user";
			s_user.DbType = CustomDBType.VarChar;
			s_user.Direction = ParameterDirection.Input;
			s_user.Index = 0;
			s_user.Size=255;
			s_user.Value = System.Web.HttpContext.Current.User.Identity.Name;;			
			...
			string s_StrSql = "PACK_MANCORRETIVA.SP_GETSINGLERDL_PREV";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();			
		...
		public DataSet GetSingleRdl_CONS(int itemId)
		{
			DataSet _Ds;
			...
			string s_StrSql = "PACK_MANCORRETIVA.SP_GETSINGLERDL_CONS";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();			
		...
		public DataSet GetSingleRdl_MAP(int itemId)
		{
			DataSet _Ds;
			...
			string s_StrSql = "PACK_MANCORRETIVA.SP_GETSINGLERDL_MAP";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();			
		...
		public DataSet GetSingleRdl_r1(int itemId)
		{
			DataSet _Ds;
			...
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_GETSINGLERDL_r1";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();			
		...
		{			
			...
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_GETALLMANUTENZIONE";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			

			return _Ds;		
		}

		public  DataSet GETALLMANUT()
		{			
			DataSet _Ds;		
			...
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_GETALLMANUT";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			

			return _Ds;		
		}
		
		public  DataSet GetRichiedente()
		{			
			DataSet _Ds;		
			...
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_GETALLRICHIEDENTE";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public  DataSet GetStatoImpianto()
		{			
			DataSet _Ds;		
			...
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_GETALLSTATOIMPIANTO";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			

			return _Ds;		
		}

		public  DataSet GetTipoAttivita()
		{			
			DataSet _Ds;		
			...
			string s_StrSql = "PACK_MANCORRETIVA.SP_GETALLTIPOATTIVITA";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public  DataSet GetDatiMAp(int id)
		{			
			DataSet _Ds;		
			...
			string s_StrSql = "PACK_MANCORRETIVA.SP_GETDATIMAP";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public  DataSet GetSoluzioni(int itemId, string problema, string causa )
		{
			DataSet _Ds;

			S_ControlsCollection _SColl = new S_ControlsCollection();

			S_Controls.Collections.S_Object s_servizi_id = new S_Object();
			s_servizi_id.ParameterName = "p_servizi_id";
			s_servizi_id.DbType = CustomDBType.Integer;
			s_servizi_id.Direction = ParameterDirection.Input;
			s_servizi_id.Index = _SColl.Count;
			s_servizi_id.Value = itemId;
			s_servizi_id.Size=10;
			_SColl.Add(s_servizi_id);

			S_Controls.Collections.S_Object s_problema = new S_Object();
			s_problema.ParameterName = "p_problema";
			s_problema.DbType = CustomDBType.VarChar;
			s_problema.Direction = ParameterDirection.Input;
			s_problema.Index = _SColl.Count;
			s_problema.Value = problema;
			s_problema.Size=500;
			_SColl.Add(s_problema);
			
			
			
			S_Controls.Collections.S_Object s_causa = new S_Object();
			s_causa.ParameterName = "p_causa";
			s_causa.DbType = CustomDBType.VarChar;
			s_causa.Direction = ParameterDirection.Input;
			s_causa.Index = _SColl.Count;
			s_causa.Value = causa;
			s_causa.Size=500;
			_SColl.Add(s_causa);
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_PROBLEMA_CAUSA_SOLUZIONE";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();			
		...
		public  DataSet GetSoluzioni_problemacausa(int id_problema_causa )
		{
			DataSet _Ds;
			...
			S_Controls.Collections.S_Object s_servizi_id = new S_Object();
			s_servizi_id.ParameterName = "p_id_problema_causa";
			s_servizi_id.DbType = CustomDBType.Integer;
			s_servizi_id.Direction = ParameterDirection.Input;
			s_servizi_id.Index = _SColl.Count;
			s_servizi_id.Value = id_problema_causa;
			s_servizi_id.Size=10;
			_SColl.Add(s_servizi_id);
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MANCORRETIVA_NUOVA.SP_SOLUZIONE_PROBLEMACAUSA";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();			
		...
		public  int ExecuteUpdateSGA_r1(S_ControlsCollection CollezioneControlli)
		{
			int i_Result=0;
			//int i_MaxParametri = CollezioneControlli.Count ;			
			...
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_MANCORRETIVA_NUOVA.sp_updateSga_r1_");

			return i_Result;
			
		}
		
		public  int insdaticontantore(S_ControlsCollection CollezioneControlli)
		{
			int i_Result=0;
			//int i_MaxParametri = CollezioneControlli.Count ;			
			...
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_MANCORRETIVA_NUOVA.insdaticontantore");
		...
		public  int Completamentonew_rev(S_ControlsCollection CollezioneControlli)
		{
			...
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_MANCORRETIVA_NUOVA.sp_Completamnetonew_rev_");
		...
		public  int Completamentonew_r1(S_ControlsCollection CollezioneControlli)
		{
			int i_Result=0;
			int i_MaxParametri = CollezioneControlli.Count;			
			...
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_MANCORRETIVA_NUOVA.sp_Completamnetonew_r1_");
		...
		public  int ExecuteUpdateMAP(S_ControlsCollection CollezioneControlli)
		{
			int i_Result=0;
			int i_MaxParametri = CollezioneControlli.Count + 1;				
			...
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_MANCORRETIVA.SP_UPDATEMAP");
