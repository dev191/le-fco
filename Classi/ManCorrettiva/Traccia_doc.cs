...
namespace TheSite.Classi.ManCorrettiva
{
	...
	public class Traccia_doc:AbstractBase
	{
		...
		public int GetCountPrev(S_ControlsCollection CollezioneControlli)
		{
			S_Controls.Collections.S_Object s_Cursor = new S_Object();
			s_Cursor.ParameterName = "IO_CURSOR";
			s_Cursor.DbType = CustomDBType.Cursor;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_TRACCIA_DOC.SP_GETCountLOGPREV";	
			DataSet _Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();
		...
		public  DataSet GetSfogliaPrev(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;	
			
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_TRACCIA_DOC.SP_GETLOGPREV";
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public  DataSet GetDestinatariInvioPrev(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;	
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_TRACCIA_DOC.SP_Destinatari_PREV";
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
