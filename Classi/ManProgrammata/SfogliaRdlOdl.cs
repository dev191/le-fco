...
namespace TheSite.Classi.ManProgrammata
{
	...
	public class SfogliaRdlOdl: AbstractBase
	{
		...
		public override DataSet GetData(S_ControlsCollection CollezioneControlli)
		{
			...
			string s_StrSql = "PACK_MAN_PROG.SP_GetSfogliaRDLPaging_rev1";	
			DataSet _Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			

			return _Ds;	
		}
		
		public DataSet GetDataRdL(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MAN_PROG.SP_GetSfogliaRDL";	
			DataSet _Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			

			return _Ds;	
		}
		
		public DataSet GetDataRdLSCH(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MAN_PROG.SP_GetSfogliaRDLSCHED";	
			DataSet _Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public  int GetDataCount(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MAN_PROG.SP_GetSfogliaRDLCount_rev1";	
			DataSet _Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
