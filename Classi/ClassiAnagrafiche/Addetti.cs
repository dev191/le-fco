...
namespace TheSite.Classi.ClassiAnagrafiche
{
	...
	public class Addetti : AbstractBase
	{
		...
		public DataSet GetDataWo(S_ControlsCollection CollezioneControlli)
		{			
			DataSet _Ds;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_ADDETTI.SP_GETALLADDETTIWO";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
...
//		S_ControlsCollections CollezioneControlli=new S_ControlsCollection(); 
		...
		public  DataSet GetDataRdlAdd(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;
			...
			s_p_utente.Index = 0;
			s_p_utente.Size=50;
			s_p_utente.Value=System.Web.HttpContext.Current.User.Identity.Name;
			...
			ApplicationDataLayer.OracleDataLayer _OraDL=new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_ADDETTI.SP_GETADDETTORDL";
			_Ds=_OraDL.GetRows(CollezioneControlli,s_StrSql).Copy();
			return _Ds;
		}

		public  DataSet GetDataRdlAdd1(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;
			...
			ApplicationDataLayer.OracleDataLayer _OraDL=new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_ADDETTI.SP_GETADDETTORDL1";
			_Ds=_OraDL.GetRows(CollezioneControlli,s_StrSql).Copy();
			return _Ds;
		}
		...
		public DataSet GetDataTR(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDL=new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_ADDETTI.SP_GETTR1";
			_Ds=_OraDL.GetRows(CollezioneControlli,s_StrSql).Copy();
			return _Ds;
		}
