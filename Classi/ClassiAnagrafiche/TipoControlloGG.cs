...
{
	/// <summary>
	/// Descrizione di riepilogo per TipoControlloGG.
	/// </summary>
	public class TipoControlloGG: AbstractBase
	{
		public TipoControlloGG(){}
		...
		{			
			...
			string s_StrSql = "PACK_COMMON.SP_GETALLTIPOCONTROLLOGG";	
		...
		public override DataSet GetData(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDL=new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_SERVIZI.SP_GETSETTORE";
			_Ds=_OraDL.GetRows(CollezioneControlli,s_StrSql).Copy();
			return _Ds;
		}
		public override DataSet GetSingleData(int itemId)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_SERVIZI.SP_GETSINGLESETTORE";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		protected override int ExecuteUpdate(S_ControlsCollection CollezioneControlli, ExecuteType Operazione, int itemId)
		{
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_SERVIZI.SP_EXECUTESETTORE");
