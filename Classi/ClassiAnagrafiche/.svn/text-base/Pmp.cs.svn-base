...
{
	/// <summary>
	/// Descrizione di riepilogo per Pmp.
	/// </summary>
	public class Pmp: AbstractBase
	{
		...
		public override DataSet GetData(S_ControlsCollection CollezioneControlli)
		{
			...
			string s_StrSql = "PACK_PMP.SP_GETPMP";
		...
		public DataSet GetAllTr()
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDL=new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_SPECIALIZZAZIONI.SP_GETALLTR";
			_Ds=_OraDL.GetRows(CollezioneControlli,s_StrSql).Copy();
			return _Ds;
		}
		...
		public override DataSet GetSingleData(int itemId)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_PMP.SP_GETSINGLEPMP";	
		...
		//ritorna il servizio a cui appartiene lo standard
		public DataSet GetStdData(int itemId)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_PMP.SP_GETSINGLESTDDASERVIZIO";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();			
		...
		protected override int ExecuteUpdate(S_ControlsCollection CollezioneControlli, ExecuteType Operazione, int itemId)
		{
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_PMP.SP_EXECUTEPMP");
