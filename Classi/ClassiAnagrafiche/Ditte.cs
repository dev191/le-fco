...
namespace TheSite.Classi.ClassiAnagrafiche
{
	...
	/// </summary>
		...
		public class Ditte : AbstractBase
		{
			...
			public  DataSet GetDataSv(int itemId)
			{
				DataSet _Ds;
				...
				s_UserName.ParameterName = "p_id_ditta";
				s_UserName.DbType = CustomDBType.Integer;
				s_UserName.Direction = ParameterDirection.Input;
				s_UserName.Index = 0;
				s_UserName.Value = itemId;			
				s_UserName.Size = 50;
...
//				s_UserName.Size = 50;
				...
				ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
				string s_StrSql = "PACK_DITTE.SP_GETALLSERVIZI_rv0";	
				_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
