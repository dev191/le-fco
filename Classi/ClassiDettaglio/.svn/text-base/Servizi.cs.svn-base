...
namespace TheSite.Classi.ClassiDettaglio
{
	...
	public class Servizi : AbstractBase
	{
		...
		public override DataSet GetData()
		{
			...
			string s_StrSql = "PACK_SERVIZI.SP_GETALLSERVIZI_rv0";	
		...
		public override DataSet GetData(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_SERVIZI.SP_GETALLSERVIZI_rv1";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public  DataSet GetServiziEdifici_rv(int id_eq)
		{
			DataSet _Ds;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_COMMON.SP_GETSERVIZIEDIFICI_rv";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();
			this.Id = id_eq;
			return _Ds;		
		}
