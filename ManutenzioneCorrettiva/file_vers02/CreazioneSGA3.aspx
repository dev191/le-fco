						...
						<TD vAlign="top" align="left" height="100%">
							<TABLE id="tblBlSearch" cellSpacing="1" cellPadding="1" border="0">
								...
								<tr>
									<td>
										Richiedente:
										<asp:dropdownlist id="cmbsrichiedente" runat="server" Width="216px"></asp:dropdownlist>
									</td>
								</tr>
								<TR>
									<TD>
								...
								<TR>
									<TD><asp:linkbutton id="LinkApprovate" runat="server" CssClass="LabelInfo" CausesValidation="False">Richieste Emesse</asp:linkbutton></TD>
								</TR>
								<TR>
									<TD>
										...
										<div id="PanelServizio">
											<TABLE id="Table2" style="WIDTH: 100%" cellSpacing="1" cellPadding="1" border="0">
												<TR>
													...
													<td><asp:dropdownlist id="cmbsTipoManutenzione" runat="server" width="350px" AutoPostBack="True"></asp:dropdownlist>
														<asp:requiredfieldvalidator id="rfvTipoManutenzione" runat="server" ErrorMessage="Selezionare un Tipo Manutenzione">*</asp:requiredfieldvalidator>
													</td>
												</TR>
												<TR>
													<TD width="15%"><B>Servizio:</B></TD>
													<TD><asp:dropdownlist id="cmbsServizio" runat="server" Width="350px" AutoPostBack="True"></asp:dropdownlist>
														<asp:requiredfieldvalidator id="rfvServizio" runat="server" ErrorMessage="Selezionare un Servizio">*</asp:requiredfieldvalidator>
													</TD>
													<TD width="15%">
														<div style="DISPLAY:none">
															Centro di Costo:</div>
													...
													<td colSpan="3">
														<div style="DISPLAY:none">
															<asp:dropdownlist id="cmbsCdC" runat="server" Width="350px"></asp:dropdownlist>
															<asp:requiredfieldvalidator id="rfvCdC" runat="server" ErrorMessage="Selezionare un Centro di Costo">*</asp:requiredfieldvalidator>
														</div>
													</td>
												</TR>
												<TR>
													<TD width="15%"><SPAN>Standard Apparecchiatura:</SPAN></TD>
													<TD colSpan="5"><asp:dropdownlist id="cmbsApparecchiatura" runat="server" Width="350px" AutoPostBack="True"></asp:dropdownlist>
														<asp:requiredfieldvalidator id="rfvApparecchiaturaStd" runat="server" ErrorMessage="Selezionare uno Standard">*</asp:requiredfieldvalidator>
													</TD>
												</TR>
											</TABLE>
										</div>
													...
													<TD colSpan="2">
														<TABLE id="TableProblemaBreve" style="WIDTH: 100%" cellSpacing="1" cellPadding="1" border="0">
															<TR>
																...
																<TD width="85%"><asp:textbox id="txtsProblemaBreve" runat="server" Width="100%"></asp:textbox>
																	<asp:requiredfieldvalidator id="rfvProblemaBreve" runat="server" ErrorMessage="Indicare una Descrizione Problema Note ">*</asp:requiredfieldvalidator>
																</TD>
															</TR>
														</TABLE>
													</TD>
									...
									<TD>
										<div id="DivMP">
											<TABLE id="TablePP" style="WIDTH: 100%" cellSpacing="1" cellPadding="1" border="0">
												...
												<TR>
													<TD width="15%">Attività Operative:</TD>
													<TD><asp:textbox id="txtsProblema" runat="server" Width="100%" 
															Height="100px" BackColor="Silver"
															ReadOnly="True" TextMode="MultiLine" Rows="4"></asp:textbox>
														<asp:requiredfieldvalidator id="rfvAttivitaOperative" runat="server" ErrorMessage="Indicare le Attivita Operative">*</asp:requiredfieldvalidator>
													</TD>
												</TR>
											</TABLE>
										</div>
