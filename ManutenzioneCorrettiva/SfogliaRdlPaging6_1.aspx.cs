...
namespace TheSite.ManutenzioneCorrettiva
{
	...
	/// </summary>
	public class SfogliaRdlPaging6_1 :  System.Web.UI.Page
	{
		#region variabili
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string _mypage="./ManutenzioneCorrettiva/SfogliaRdlPaging6_1.aspx";			
			...
			{	
				...
				if(Context.Handler is TheSite.ManutenzioneCorrettiva.CompletaRdl2 || Context.Handler is TheSite.ManutenzioneCorrettiva.EditApprovaEmetti)
				{
					_fp1= Context.Handler as ManutenzioneCorrettiva.CompletaRdl2;
					if (_fp1!=null)
					{
						_myColl= ((ManutenzioneCorrettiva.CompletaRdl2)_fp1)._Contenitore;
		...
		private void BindTipoAttivita()
		{
			...
			if (_MyDs.Tables[0].Rows.Count>0)
			{
				...
				this.cmbsTipoAttivita.DataSource = Classi.GestoreDropDownList.ItemBlankDataSource(
					_MyDs.Tables[0], "DESCRIZIONE", "id", "- Selezionare un Tipo Attività -", "0");
...
//			_SCollection.Add(p_idmap);
		...
		private void DataGridRicerca_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			{ 
				...
				string appo2 ="CompletaRdl2.aspx?wr_id=' + DataBinder.Eval(Container.DataItem,'WR_ID')" + varapp;
				string appo="CompletaRdl2.ascx?wr_id=' + DataBinder.Eval(Container.DataItem,'WR_ID')" + varapp;
				...
				if(e.Item.Cells[20].Text.Trim()=="4" || e.Item.Cells[20].Text.Trim()=="2")//  se è stato approvato
				{
					_imgOK.Visible=true;
				...
				else
				{
					...
					{         
						...
						case "1":    // livello   cte il primo che Autorizza  LIVA    
							...
							//							}
							//							break;
						case "2":      // livello   ULTIMO è STATO TUTTO AUTORIZZATO il terzo che Autorizza        							 
							_imgVerde.Visible=false;
							_imgVerde.ToolTip = "La RDL è stata Approvata Definitivamente";
							_imgRossa.Visible=false;
							_imgRossa.ToolTip =  "La RDL è stata Rifiutata Definitivamente";
							_imgLuc.Visible=true;
							_imgLuc.Attributes.Add("title",tooltip_imgLuc);
							break;
						default: 
		...
		private void DataGridRicerca2_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			{ 
				...
				string appo2 ="CompletaRdl2.aspx?wr_id=' + DataBinder.Eval(Container.DataItem,'WR_ID')" + varapp;
				string appo="CompletaRdl2.aspx?wr_id=' + DataBinder.Eval(Container.DataItem,'WR_ID')" + varapp;
