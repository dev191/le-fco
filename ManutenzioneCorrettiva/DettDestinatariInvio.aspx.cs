...
namespace TheSite.ManutenzioneCorrettiva
{
	...
	public class DettDestinatariInvio : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(Request.QueryString["nome_doc"]!= "")
				Nome_doc= Request.QueryString["nome_doc"].ToString();
	...
	private void Ricerca()
	{
		...
		s_p_TIPO_DOC.Index =_SCollection.Count;
		s_p_TIPO_DOC.Size=50;
		s_p_TIPO_DOC.Value =Tipo_doc;		
