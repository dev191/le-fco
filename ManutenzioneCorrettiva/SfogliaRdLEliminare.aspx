...
<UC1:RICERCAMODULO id=RicercaModulo1 runat="server"></UC1:RICERCAMODULO></TD></TR>
              <TR>
                <TD style="WIDTH: 83px" width=83 align=left>Richiesta di 
                  Lavoro:</TD>
                <TD width="30%">
<CC1:S_TEXTBOX id=txtsRichiesta runat="server" dbparametername="p_Wr_Id" dbdirection="Input" dbsize="255" maxlength="10" dbdatatype="Integer" dbindex="2" width="100px"></CC1:S_TEXTBOX></TD>
...
<ASP:COMPAREVALIDATOR id=CompareValidator1 runat="server" display="Dynamic" type="Date" operator="GreaterThanEqual" errormessage="Data non valida!"></ASP:COMPAREVALIDATOR></TD></TR>
              <TR>
                ...
                <TD>
<CC1:S_TEXTBOX id=txtsOrdine runat="server" dbparametername="p_Wr_Id" dbdirection="Input" dbsize="255" maxlength="10" width="100px"></CC1:S_TEXTBOX></TD>
...
<CC1:S_COMBOBOX id=cmbsUrgenza runat="server" width="99%"></CC1:S_COMBOBOX></TD></TR>
              <TR>
                <TD style="WIDTH: 83px" align=left>Descrizione:</TD>
                <TD colSpan=3>
<CC1:S_TEXTBOX id=txtDescrizione runat="server" dbparametername="p_Wr_Id" dbdirection="Input" dbsize="255" maxlength="255" width="99%"></CC1:S_TEXTBOX></TD></TR>
              <TR>
                <TD style="WIDTH: 83px; DISPLAY: none" id=tblTipoManutenzione 
                align=left>Tipo Manutenzione:</TD>
                <TD style="DISPLAY: none" id=tblTipoManutenzione1>
<CC1:S_COMBOBOX id=cmbsTipoManutenzione runat="server" width="99%"></CC1:S_COMBOBOX></TD>
                <TD style="DISPLAY: none" id=tabletipointervento>Tipo 
                  Intervento:</TD>
...
<UC1:CALENDARPICKER id=CalendarPicker4 runat="server"></UC1:CALENDARPICKER></TD></TR>
              <TR>
                <TD style="HEIGHT: 16px" colSpan=4 align=left></TD></TR>
              <TR>
