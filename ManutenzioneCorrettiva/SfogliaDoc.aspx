										...
										<TD style="HEIGHT: 72%" vAlign="top" align="center"><uc1:gridtitle id="GridTitle1" runat="server"></uc1:gridtitle><asp:datagrid id="DataGridRicerca" runat="server" CssClass="DataGrid" AllowCustomPaging="True"
												...
												<Columns>
													...
													<asp:TemplateColumn>
														...
														<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
														<ItemTemplate>
															<a href='<%# "DettDestinatariInvio.aspx?Wr_id=" + DataBinder.Eval(Container.DataItem,"id_wr")
															+ "&Tipo_doc=" + DataBinder.Eval(Container.DataItem,"tipo_doc")
															+ "&bl_id=" + DataBinder.Eval(Container.DataItem,"id")
															+ "&nome_doc=" + DataBinder.Eval(Container.DataItem,"nome_doc")
															%>' target=_blank runat="server" id="imagefull">
