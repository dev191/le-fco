					...
					<tr>
						<TD height="100%" vAlign="top" align="left">
							<TABLE id="tblBlSearch" border="0" cellSpacing="1" cellPadding="1">
												...
												<TR>
													...
													<TD><asp:dropdownlist id="cmbsServizio" runat="server" Width="350px" AutoPostBack="True"></asp:dropdownlist>
														<asp:requiredfieldvalidator id="RequiredfieldvalidatorServ" runat="server" ErrorMessage="Selezionare un servizio"
															InitialValue="0" ControlToValidate="cmbsServizio">*
															</asp:requiredfieldvalidator>
													</TD>
													<td>
													<TD width="15%"><B>Centro di Costo</B></TD>
													<td colSpan="3"><asp:dropdownlist id="cmbsCdC" runat="server" Width="350px"></asp:dropdownlist>
														<asp:requiredfieldvalidator id="RequiredfieldvalidatorCdC" runat="server" ErrorMessage="Selezionare un Centro di Costo"
															InitialValue="0" ControlToValidate="cmbsCdC">*
															</asp:requiredfieldvalidator>
													</td>
												</TR>
												<TR>
								...
								<TR>
									<TD>
										<div id="aseguito4"><span>Causa presunta guasto/anomalia</span><asp:textbox id="TxtCausa" runat="server" Width="100%" MaxLength="408" Rows="4" TextMode="MultiLine"
