...
<%@ Page language="c#" Codebehind="SfogliaRdlPaging6.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneCorrettiva.SfogliaRdlPaging6" %>
									...
									<TR>
										<TD style="HEIGHT: 25%" vAlign="top" align="left"><COLLAPSE:DATAPANEL id="PanelRicerca" runat="server" ExpandImageUrl="../Images/down.gif" CollapseImageUrl="../Images/up.gif"
												...
												<TABLE id="tblSearch100" border="0" cellSpacing="1" cellPadding="2">
													...
													<TR>
														<TD width="13%" align="left">RdL nr:</TD>
														<TD width="30%">
													...
													<TR>
														...
														<TD>
															<cc1:s_combobox id="cmbsServizio" runat="server" Width="99%" AutoPostBack="True"></cc1:s_combobox></TD>
														<TD align="left">
													...
													<TR>
														<TD align="left">Std. Apparecchiatura:
														</TD>
														<TD>
															<cc1:S_ComboBox id="cmbsApparecchiatura" runat="server" Width="99%"></cc1:S_ComboBox></TD>
														<TD colSpan="2"></TD>
													</TR>
													<TR>
														<TD colSpan="4">
													...
													<TR>
														...
														<TD style="HEIGHT: 22px" align="left">Stato&nbsp;Impianto:</TD>
														<TD style="HEIGHT: 22px">
