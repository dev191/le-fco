<%@ Page language="c#" Codebehind="CompletaRdl2.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneCorrettiva.CompletaRdl2" %>
...
<meta name=vs_targetSchema content=http://schemas.microsoft.com/intellisense/ie5><LINK rel=stylesheet type=text/css href="../Css/MainSheet.css" >
...
<script>
	...
	{	
		...
		var crtl33;var crtl34;var crtl35;var crtl36;var crtl37;
		var crtl38;
...
<TABLE style="Z-INDEX: 101; POSITION: absolute; TOP: 8px; LEFT: 8px" id=Table1 
...
<ASP:LABEL id=presidio runat="server" width="0px" Height="0px"></ASP:LABEL></TD></TR>
              <TR>
                ...
                <TD colSpan=3>
                  <DIV id=t14>
<CC1:S_COMBOBOX id=cmbsServizio runat="server" width="480px" Enabled="False" autopostback="True"></CC1:S_COMBOBOX></DIV></TD></TR>
              <TR>
                <TD>
                  <DIV id=t15><B>Tipo Attività:</B></DIV></TD>
                <TD colSpan=3>
                  <DIV id=t16>
<CC1:S_COMBOBOX id=cmbsSettore runat="server" width="480px" Enabled="False" autopostback="True"></CC1:S_COMBOBOX></DIV></TD></TR><!--
												<TR>
              ...
              <TR>
                ...
                <TD colSpan=3>
                  <DIV id=t18>
<CC1:S_COMBOBOX id=cmdsStdApparecchiatura runat="server" width="480px" Enabled="False" dbsize="10" dbparametername="p_eqstd_id" dbdirection="Input" dbindex="1" AutoPostBack="True" dbdatatype="Integer"></CC1:S_COMBOBOX></DIV></TD></TR>
              <TR>
                <TD>
                  <DIV id=t19><B>Apparecchiatura:</B></DIV></TD>
                <TD colSpan=3>
                  <DIV id=t20>
<CC1:S_COMBOBOX id=cmbEQ runat="server" width="480px" Enabled="False" dbsize="10" dbparametername="p_id_eq" dbdirection="Input" dbindex="1" dbdatatype="Integer"></CC1:S_COMBOBOX></DIV></TD></TR>
              <TR>
                <TD>
...
<CC1:S_TEXTBOX style="TEXT-ALIGN: right" id=txtPercentuale2 runat="server" width="24px" maxlength="2"></CC1:S_TEXTBOX>%</B></TD></TR></TABLE></TD></TR>
              <TR id=trprev3>
                <TD style="WIDTH: 139px" class=sga><B 
                  class=blueoverline>Modalità di Pagamento:</B></TD>
                <TD colSpan=3>
<CC1:S_TEXTBOX id=txtModalitaPagamento runat="server" width="480px" height="34px" MaxLength="112" textmode="MultiLine"></CC1:S_TEXTBOX></TD></TR></TABLE></cc2:datapanel></TD></TR>
        <TR>
          <TD><cc2:datapanel id=Datapanel2 
            ...
            expandimageurl="../Images/down.gif" collapsetext="Riduci" 
            collapseimageurl="../Images/up.gif" allowtitleexpandcollapse="True" 
            cssclass="DataPanel75"><INPUT style="WIDTH: 392px; HEIGHT: 18px" 
            id=UploadFile size=46 type=file name=UploadFile 
            runat="server">&nbsp; 
            ...
            >
              ...
              <TR>
                <TD style="WIDTH: 11.3%">
                  ...
                  Proposta:</B> </DIV></TD>
                <TD colSpan=3>
                  <DIV style="DISPLAY: none"><CC1:S_TEXTBOX id=txtSoluzioneProposta runat="server" width="480px" height="34px" MaxLength="408" textmode="MultiLine">
                  </CC1:S_TEXTBOX></DIV></TD></TR>
              <TR>
                <TD><B>Attività 
                  Operative:</B></TD>
              ...
              <TR>
                ...
                <TD colSpan=3>
                  <DIV style="DISPLAY: none"><CC1:S_TEXTBOX id=txtNoteSga runat="server" width="480px" height="34px" MaxLength="408" textmode="MultiLine"></CC1:S_TEXTBOX></DIV></TD></TR>
              <TR>
                <TD style="WIDTH: 139px">
...
<asp:label id=LblDataInvioSga runat="server" Font-Bold="True"></asp:label></DIV></TD></TR>
              <tr>
                <td></TD>
                <TD>
                  <div id=lHAttcond><asp:hyperlink id=HAttcond runat="server">Visualizza Attività Conduzione</asp:hyperlink></DIV></TD>
                <TD colSpan=2></TD></TR>
              <TR>
                <TD><STRONG 
                  >Addetto-Ditta 
              ...
              <TR>
                <TD colSpan=4 align=center><asp:button id=btChiudi1 runat="server" Width="135px" Text="Chiudi"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<CC1:S_TEXTBOX id=txtNoteCompletamento runat="server" width="480px" height="34px" MaxLength="215" textmode="MultiLine"></CC1:S_TEXTBOX></TD></TR>
        <TR>
          ...
          <TD colSpan=3>
<CC1:S_TEXTBOX id=txtlettura onkeypress=SoloNumerip() runat="server" width="150" MaxLength="150">0</CC1:S_TEXTBOX></TD></TR>
        <TR>
          <TD class=die>
            <DIV style="DISPLAY: none"><STRONG 
...
<asp:CheckBox id=Ck1 runat="server" Visible="False" Text="Gli apparati sono perfettamente funzionanti" CssClass="blueoverline"></asp:CheckBox></TD>
                <TD class=die>
<asp:CheckBox id=Ck2 runat="server" Visible="False" Text="L'installazione è conforme alle norme vigenti" CssClass="blueoverline"></asp:CheckBox></TD></TR></TABLE></DIV></TD></TR>
        <TR>
          <TD class=die>
            <DIV style="DISPLAY: none"><STRONG 
          class=blueoverline></STRONG></DIV></TD>
...
<asp:button id=btMAP runat="server" Width="135px" Text="Salva MAP/Invia Email"></asp:button></TD></TR></TABLE></cc2:datapanel></DIV></TD></TR>
  <TR>
    <TD align=center>
      <div style="WIDTH: 100%; HEIGHT: 85px" id=azioni class=DataPanel75 
       runat="server">
      <TABLE border=0 width="100%">
        ...
        <TR>
          ...
          <TD></TD>
          <TD></TD>
          <TD></TD></TR></TABLE></DIV></TD></TR></TABLE>&nbsp; 
</FORM>
	</body>
</HTML>
