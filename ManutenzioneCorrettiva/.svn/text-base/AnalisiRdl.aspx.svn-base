									...
									<TR>
										<TD style="HEIGHT: 25.11%" vAlign="top" align="left">
											<COLLAPSE:DATAPANEL id="PanelRicerca" runat="server" TitleStyle-CssClass="TitleSearch" CssClass="DataPanel75"
												TitleText="Ricerca" AllowTitleExpandCollapse="True" Collapsed="False" ExpandText="Espandi" CollapseText="Espandi/Riduci"
												...
												<TABLE id="tblSearch100" border="0" cellSpacing="1" cellPadding="2">
													...
													<TR>
														...
														<TD>
															<cc1:s_textbox id="txtswo_id" runat="server" DBDataType="Integer" DBIndex="2" DBParameterName="p_wo_id"
																DBDirection="Input" width="70%" DBSize="10"></cc1:s_textbox></TD>
													</TR>
													<TR>
														<TD align="left">Richiesta&nbsp;di Lavoro:</TD>
														<TD>
															<cc1:s_textbox id="txtswr_id" runat="server" DBDataType="Integer" DBIndex="3" DBParameterName="p_wr_id"
																DBDirection="Input" width="70%" DBSize="10"></cc1:s_textbox></TD>
														<TD style="WIDTH: 125px" align="left">Stato:</TD>
														<TD>
															<cc1:S_ComboBox id="cmbsid_status" runat="server" DBDataType="Integer" DBIndex="4" DBParameterName="p_stato_id"
																DBDirection="Input" DBSize="10" Width="280px"></cc1:S_ComboBox></TD>
													</TR>
													<TR>
														<TD colSpan="4" align="left"></TD>
													</TR>
													<TR>
														<TD style="WIDTH: 447px" colSpan="3" align="left">
									...
									<TR>
										<TD style="HEIGHT: 72%" vAlign="top" align="center"><uc1:gridtitle id="GridTitle1" runat="server"></uc1:gridtitle><asp:datagrid id="DataGridRicerca" runat="server" CssClass="DataGrid" AutoGenerateColumns="False"
												...
												<Columns>
													...
													<asp:BoundColumn DataField="OdL" HeaderText="OdL">
													...
													<asp:BoundColumn DataField="Priorita" HeaderText="Urgenza">
