...
namespace TheSite.ManutenzioneCorretiva
{
	...
	public class VisualizzaRdl1 : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Label lblrepeat;
		protected System.Web.UI.WebControls.Label lblattoperative;
		...
		protected System.Web.UI.WebControls.Label lbsettore;
...
//				}
		...
		private void btnsNuova_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("CreazioneSGA3.aspx?FunId=" + FunId + VarApp);
		}

		private void cmdApprova_Click(object sender, System.EventArgs e)
		{
			Response.Redirect("CompletaRdl1.aspx?wr_id="+ txtWrHidden.Text+"&chiamante=VisualizzaRdl1");	
		}
		...
		private void btnModificaRDL_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("CreazioneSGA3.aspx?ItemId=" + txtWrHidden.Text +"&chiamante=VisualizzaRdl1"+ VarApp);			
		}
