...
////
	...
	public class sfogliaCP : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!IsPostBack)
			{
				...
				if(Context.Handler is TheSite.GestioneControlliPeriodici.CompletamentoCP)
				{
					...
					_fp2 = (TheSite.GestioneControlliPeriodici.CompletamentoCP)Context.Handler;
		...
		private void CaricaCombiAnni()
		{
			...
			for (int i = 2000; i <= Int32.Parse(anno_corrente) +5; i++)
			{ 
		...
		{	
			...
			if (_MyDs.Tables[0].Rows.Count > 0)
			{
				...
				/*MDI commentato perche il servizio è solo il 461 CONTROLLI PERIODICI
		...
		private void DataGrid1_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if( e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem )
			{
				...
				else
				{
					...
					lk.CommandArgument=DataBinder.Eval(e.Item.DataItem, "ordine").ToString();
					lk.Text ="Da Completare";
					lk.CommandName="lkin"; 
		...
		public void LinkButton1_Click(Object sender, CommandEventArgs e) 
		{
			...
			Context.Items.Add("ordine",e.CommandArgument);			
			Server.Transfer("GestioneCP.aspx?FunId=" + FunId); 
		}
