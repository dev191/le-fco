...
{
	/// <summary>
	/// Descrizione di riepilogo per CompletamentoCP.
	/// </summary>
////////	public class CompletamentoCP_primo : System.Web.UI.Page
////////	{
...
////////	}
	...
	/// </summary>   CompletamentoMP1
	public class CompletamentoCP  : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!Page.IsPostBack)
			{
				...
				BindControls();				
				if(Context.Handler is TheSite.GestioneControlliPeriodici.CompletamentoCPWrList)
				{
					//_fp = (TheSite.ManutenzioneProgrammata.Completamento_MP_WRList)Context.Handler;
					_fp = (TheSite.GestioneControlliPeriodici.CompletamentoCPWrList)Context.Handler;
					if (_fp!=null) 
					{
		...
		{    
			...
			this.DataGridRicerca.ItemCommand += new System.Web.UI.WebControls.DataGridCommandEventHandler(this.DataGridRicerca_ItemCommand_1);
		...
		{
			Server.Transfer("SfogliaOdlRdl1.aspx?FunID="+FunId); 		
		}
		...
		{	
			...
			{
				Classi.SiteJavaScript.WindowOpen(this.Page,0,"Completa_WO1.aspx?addetto=" + cmbsAddettoCompl.SelectedValue+ "&data=" + CalendarPicker1.Datazione.Text+ "&data1=" + CalendarPicker2.Datazione.Text ,800,600,"dettaglio");			
		...
		{
			Response.Redirect("CompletamentoMP1.aspx?FunID=" + ViewState["FunId"]);
		}
		...
		private void DataGridRicerca_ItemCommand_1(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
