...
<%@ Page language="c#" Codebehind="CompletamentoCP.aspx.cs" AutoEventWireup="false" Inherits="TheSite.GestioneControlliPeriodici.CompletamentoCP" %>
		...
		function ControllaData()
			{						
				...
				if(document.getElementById("txtHidden").value=='1')				
				{
					...
					var data1 = document.getElementById("<%=CalendarPicker2.Datazione.ClientID%>");
					
					if (data.value=="")					
					{	
						alert("La data di Inizio Effettivo è obbligatoria.");
						return false;
					}
					if (data.value=="")					
					{	
						alert("La data di Completamento Effettivo è obbligatoria.");
						return false;
					}
...
<body bottomMargin=0 onbeforeunload=parent.left.valorizza() leftMargin=5 
topMargin=0 rightMargin=0  MS_POSITIONING="GridLayout"(??)>
<form id=Form1 onsubmit="return ControllaData(chiudi);" method=post runat="server">
<TABLE id=TableMaincellSpacing= 
style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px" cellPadding=0 
      ...
      >
        ...
        <TR>
          <TD style="HEIGHT: 25.11%" vAlign=top align=left 
            ><COLLAPSE:DATAPANEL id=PanelRicerca 
             runat="server" 
            ExpandImageUrl="../Images/down.gif" 
            CollapseImageUrl="../Images/up.gif" CollapseText="Riduci" 
            ExpandText="Espandi" Collapsed="False" 
...
<cc1:S_Button id=btnSChiudi runat="server" CssClass="btn" Width="98px" Text="INDIETRO"></cc1:S_Button>&nbsp; 
                  <INPUT type=hidden name=hidRicerca></TD>
                <TD align=right><A class=GuidaLink href="<%= HelpLink %>" 
                  target=_blank>Guida</A></TD></TR></TABLE><INPUT id=txtHidden 
            type=hidden value=0></COLLAPSE:DATAPANEL></TD></TR>
        <tr>
          <TD style="HEIGHT: 3%" align=center></TD></tr>
        <TR>
          <TD style="HEIGHT: 72%" vAlign=top align=center><uc1:gridtitle id=GridTitle1 runat="server">
          </uc1:gridtitle>
          
          
          <asp:datagrid id=DataGridRicerca runat="server" CssClass="DataGrid" AutoGenerateColumns="False" GridLines="Vertical" BorderWidth="1px" BorderColor="Gray" AllowPaging="True">
...
<Columns>
<asp:BoundColumn DataField="ordine" HeaderText="Ordine di lavoro"></asp:BoundColumn>
<asp:TemplateColumn Visible="False" HeaderText="Ordine di Lavoro">
...
<ItemTemplate>
<asp:LinkButton CommandName="Dettaglio" Text='<%# DataBinder.Eval(Container.DataItem,"ID") %>' CommandArgument= '<%# "CompletamentoCPWrList.aspx?wo_id=" + DataBinder.Eval(Container.DataItem,"ID")%>' runat="server" ID="Linkbutton1"/>

												
</ItemTemplate>
</asp:TemplateColumn>
<asp:BoundColumn Visible="False" DataField="Localita" HeaderText="Localit&#224;">
...
<asp:BoundColumn Visible="False" DataField="Denominazione" HeaderText="Den. Edificio"></asp:BoundColumn>
<asp:BoundColumn DataField="Servizio" HeaderText="Servizio"></asp:BoundColumn>
<asp:BoundColumn Visible="False" DataField="MC" HeaderText="MC"></asp:BoundColumn>
<asp:BoundColumn DataField="DataPianificata" HeaderText="Data Sched." DataFormatString="{0:d}"></asp:BoundColumn>
...
<PagerStyle Mode="NumericPages">
        ...
        <TR>
          	<td><COLLAPSE:DATAPANEL id="DatapanelCompleta" runat="server" TitleStyle-CssClass="TitleSearch" CssClass="DataPanel75"
												...
												Visible="False">
            <TABLE style="WIDTH: 937px; HEIGHT: 190px" height=190 align=center 
            border=1>
              <TBODY>
              <TR>
...
<cc1:S_Button id=btnsModificaODL runat="server" CssClass="btn" Width="98px" Text="MODIFICA ODL"></cc1:S_Button></TD></TR></TABLE></TD></TR>
              <TR>
                <TD align=center 
            colSpan=2></COLLAPSE:DATAPANEL></td></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></form></TR></TBODY></TABLE></TR></TBODY></TABLE></TR></TBODY></TABLE></FORM>
