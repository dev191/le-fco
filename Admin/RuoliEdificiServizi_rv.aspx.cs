...
namespace TheSite.Admin
{
	...
	/// </summary>
	public class RuoliEdificiServizi_rv : System.Web.UI.Page
	{
...
//			}
			...
			{	
				...
				this.lblOperazione.Text = "Apparato padre - apparati figlio";
...
//			}
		...
		private TreeNodeCollection AddNodesServizi1(string id_bl,DataRow Dr, TreeNodeCollection nodes)
		{	
			TreeNode n =new TreeNode();
			n.Type = "apparati figlio";			
			n.Text = Dr["DESCRIZIONE"].ToString();
...
//		}
		...
		private DataRowCollection DatiEdificio(Int32 id_eq)
		{
			int servizio_id=0;
			if (cmbsServizi.SelectedValue!="")
				servizio_id=Int32.Parse(cmbsServizi.SelectedValue);			
			...
			Classi.ClassiDettaglio.Servizi  _Servizi= new TheSite.Classi.ClassiDettaglio.Servizi();
			DataSet Ds;							
			Ds = _Servizi.GetServiziEdifici_rv(id_eq);
			return Ds.Tables[0].Rows; 
		}
